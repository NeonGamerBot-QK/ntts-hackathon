        ...
        require('child_process').exec(`git pull -v`, (error, stdout) => {
            ...
            if (!error) {
                if (!response.includes("Already up to date.")) {
                  ...
                  const content = `<t:${Date.now().toString().slice(0, -3)}:f> Automatic update from GitHub, pulling files. [\`${compareStr}\`](https://github.com/NeonGamerBot-QK/mybot/compare/${compareStr})\n\`\`\`${cap(response, 1700)}\`\`\`\n## Current Branch \n[\`View Changes\`](https://github.com/NeonGamerBot-QK/myBot/commit/${bhash})     [\`Branch\`](https://github.com/NeonGamerBot-QK/myBot/tree/${bhash})       **Commit Message**: \`${bcommitMessage.replace('\n', '')}\`\n## Latest Branch\n[\`View Changes\`](https://github.com/NeonGamerBot-QK/myBot/commit/${hash})     [\`Branch\`](https://github.com/NeonGamerBot-QK/myBot/tree/${hash})       **Commit Message**: \`${commitMessage}\``
